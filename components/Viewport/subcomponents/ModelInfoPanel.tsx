...
export const ModelInfoPanel: React.FC<ModelInfoPanelProps> = ({ model, adhesionOffset }) => {
  ...
  return (
    <div className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-2 flex flex-col gap-2 rounded-lg shadow-sm">
      {/* Header */}
      <div className="flex items-center gap-2 pb-1.5 border-b border-slate-100 dark:border-slate-700/50">
        <div className="w-4 h-4 bg-slate-100 dark:bg-slate-700 flex items-center justify-center text-slate-400 shrink-0 rounded">
      ...
      {/* Dimensions */}
      <div className="grid grid-cols-3 gap-px bg-slate-100 dark:bg-slate-700 border border-slate-100 dark:border-slate-700 overflow-hidden rounded">
        <div className="bg-white dark:bg-slate-800 p-1.5">
      ...
      {isAdv && (
        <div className="bg-primary/5 border border-primary/20 p-1 rounded">
